...
{% details repository.js %} content {% enddetails %}
{% details rollup.config.mjs %} content {% enddetails %}
{% details public/signin.html %} content {% enddetails %}
{% details public/signup.html %} content {% enddetails %}
{% details public/style.css %} content {% enddetails %}
